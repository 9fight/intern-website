...
export default function Homes() {
  ...
  const teamImages = [
    "https://hyphen-plus.com/storage/albums/21/1766476245_kSFmHOuwLS.webp",
    "https://hyphen-plus.com/storage/albums/21/1766476194_Ooa48nPKqn.webp",
    "https://hyphen-plus.com/storage/albums/21/1766476151_q2uCq4ZlmI.webp",
    "https://hyphen-plus.com/storage/albums/21/1766476277_2EznvRF2hp.webp",
    "https://hyphen-plus.com/storage/albums/21/1766476424_VNTpC2UPvb.webp",
  ];
  ...
  return (
    ...
    >
      ...
      {/* --- 2. Hero Section --- */}
      <section className="relative w-full min-h-screen flex flex-col md:flex-row items-center justify-center px-6 md:px-20 pt-24 pb-20 overflow-hidden">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center relative z-10 md:pr-16">
          ...
          >
            ...
            <h1
              className="text-6xl md:text-[5.5rem] font-black tracking-tighter mb-4 leading-[1.05] uppercase transition-colors duration-300"
              style={{
            ...
            <p className="text-xl md:text-2xl text-[#2d2d30] dark:text-gray-400 mb-12 max-w-md font-medium transition-colors duration-300">
              Startup ด้าน Software Tech & AI <br />
              <span className="text-base font-extrabold text-black dark:text-white transition-colors duration-300">Digital Innovation Solutions</span>
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              className="bg-black dark:bg-white text-white dark:text-black px-10 py-5 rounded-full font-bold flex items-center gap-2 shadow-xl transition-colors duration-300"
            >
      ...
      {/* --- 3. About Me Section --- */}
      <section className="relative py-24 px-6 md:px-20 z-10 bg-[#090912] text-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto flex flex-col items-center mb-20 relative z-10">
          <div className="flex items-center gap-6 w-full justify-center mb-3">
            <div className="h-[1px] bg-white/10 w-24 md:w-48"></div>
            <h2 className="text-3xl md:text-[2.5rem] font-semibold tracking-wide text-white">About Me</h2>
            <div className="h-[1px] bg-white/10 w-24 md:w-48"></div>
          </div>
          <p className="text-lg font-medium">Transforming ideas into digital experiences</p>
        </div>

        <div className="max-w-5xl mx-auto flex flex-col-reverse md:flex-row items-center gap-16 md:gap-24 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="w-full md:w-3/5 flex flex-col text-center md:text-left items-center md:items-start"
          >
            <p className="text-[#00E5FF] text-xl font-medium mb-3 tracking-wide">Hello, I'm</p>
            <motion.h3
              className="text-4xl md:text-[3.25rem] font-bold mb-6 leading-[1.1] tracking-tight text-transparent bg-clip-text"
              style={{
            ...
            <p className="text-[#A0A0AB] leading-relaxed text-base mb-10 text-justify md:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5">
              ...
              <a href="https://github.com/" target="_blank" className="flex items-center justify-center gap-2 px-8 py-3.5 bg-transparent border border-[#3A3A4A] hover:bg-white/5 transition-all rounded-xl text-white font-medium text-sm w-full sm:w-auto">
          ...
          >
            <motion.div
              ...
              className="w-64 h-64 md:w-[380px] md:h-[380px] rounded-full p-2 border border-[#3A3A4A] relative shadow-[0_20px_50px_rgba(0,0,0,0.5)] cursor-pointer"
            >
      ...
      {/* --- 4. Company Info --- */}
      <section className="py-28 px-6 md:px-20 relative z-10 bg-white dark:bg-[#111113] transition-colors duration-300">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row gap-20 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-7 text-black dark:text-white transition-colors duration-300">OFFICE <br />LOCATION</h2>
              <p className="text-[#424245] dark:text-gray-400 leading-relaxed text-lg mb-12 font-normal transition-colors duration-300">
              ...
              <div className="space-y-5">
                <div className="p-6 bg-black dark:bg-[#1D1D1F] rounded-[2rem] flex items-center gap-6 shadow-xl shadow-black/10 text-white hover:bg-[#1D1D1F] dark:hover:bg-[#2C2C2E] transition-colors duration-300">
                  <div className="w-14 h-14 rounded-full bg-[#1C1C1E] dark:bg-black flex items-center justify-center text-white shadow-inner"><MapPin size={24} /></div>
                  <div>
                ...
                <div className="p-6 bg-[#F5F5F7] dark:bg-[#1D1D1F] rounded-[2rem] flex items-center gap-6 hover:bg-[#EAEAEF] dark:hover:bg-[#2C2C2E] transition-colors duration-300">
                  <div className="w-14 h-14 rounded-full bg-white dark:bg-[#2C2C2E] flex items-center justify-center text-black dark:text-white shadow transition-colors duration-300"><Briefcase size={24} /></div>
                  <div>
                    <h4 className="text-black dark:text-white font-bold text-sm mb-1.5 transition-colors duration-300">เวลาทำการ</h4>
                    <p className="text-[#424245] dark:text-gray-400 text-xs md:text-sm font-medium transition-colors duration-300">จันทร์ - ศุกร์ : 8:30 – 17:30</p>
                  </div>
                </div>
              </div>
            </motion.div>

            <motion.div className="w-full md:w-1/2 h-[450px] relative rounded-[2rem] overflow-hidden bg-gray-100 dark:bg-gray-800">
              <iframe
      ...
      <section className="py-28 px-6 md:px-20 relative z-10 bg-[#F5F5F7] dark:bg-[#0a0a0c] overflow-hidden transition-colors duration-300">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-lg p-2 border border-gray-100">
                <img src="/image/logo.png" alt="Earnback Logo" className="w-full h-auto object-contain" />
              </div>
              <span className="text-sm font-bold tracking-widest text-[#00d1b2] uppercase">Featured Project</span>
            </div>

            <h2 className="text-[3.5rem] font-extrabold tracking-tighter text-black dark:text-white mb-5 leading-[1.1] transition-colors duration-300">
              Earnback App. <br />
              <span className="text-[#00d1b2]">Smart Rewards.</span>
            </h2>
            <p className="text-[#424245] dark:text-gray-400 leading-relaxed text-lg mb-10 font-normal max-w-lg transition-colors duration-300">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-black dark:bg-[#00d1b2] text-white dark:text-black font-bold px-8 py-4 rounded-full hover:bg-[#00d1b2] dark:hover:bg-white transition-all shadow-xl hover:shadow-[#00d1b2]/20"
            >
          ...
          {/* --- Phone Mockup --- */}
          <div className="w-full md:w-1/2 relative h-[650px] flex justify-center items-center">
            <motion.div
              initial={{ y: 50, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              viewport={{ once: true }}
              transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
              className="relative w-[320px] h-[640px] bg-white rounded-[3.5rem] border-[12px] border-[#1D1D1F] shadow-[0_40px_100px_rgba(0,0,0,0.2)] overflow-hidden z-20"
            >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] bg-[#00d1b2]/10 rounded-full blur-3xl -z-10 pointer-events-none"></div>
          </div>
        </div>
      </section>
